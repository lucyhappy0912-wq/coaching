...
import { findPauseReport } from "@/app/(site)/pause/actions";
import type { FindPauseState } from "@/app/(site)/pause/find-state";
import { PauseResultView } from "@/components/pause/PauseResultView";
import { HoneypotField } from "@/components/ui/HoneypotField";

const initial: FindPauseState = { error: null, scores: null };
...
export function PauseViewForm() {
  const [state, action, pending] = useActionState(findPauseReport, initial);

          ...
          <table className="w-max min-w-full text-left">
            <thead>
              <tr className="border-b border-ink-15">
                ...
                <th className="adm-label whitespace-nowrap py-3 pr-6 text-forest-70">업종</th>
                <th className="adm-label whitespace-nowrap py-3 pr-6 text-forest-70">창업 기간</th>
                <th className="adm-label whitespace-nowrap py-3 pr-6 text-forest-70">구간</th>
                <th className="adm-label whitespace-nowrap py-3 pr-6 text-forest-70">총점</th>
                <th className="adm-label whitespace-nowrap py-3 pr-6 text-forest-70">연락</th>
                <th className="adm-label whitespace-nowrap py-3 text-forest-70">작업</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row) => (

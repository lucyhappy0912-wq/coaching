...
import { PauseViewForm } from "@/components/pause/PauseViewForm";
import { Container } from "@/components/ui/Container";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "PAUSE CHECK 분석지 다시 보기",
  robots: { index: false, follow: false, nocache: true },
};

export default function PauseViewPage() {
  return (
    <div className="bg-grass-10 pt-(--header-h)">
      <Container className="mx-auto max-w-3xl py-8 sm:py-16 lg:py-24">
        ...
        <p className="b3 mt-3">
          <Link href="/pause" className="lined text-forest">
            문답 다시 하기
          </Link>
        </p>
        <PauseViewForm />
